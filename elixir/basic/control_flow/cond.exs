...
IO.inspect(result) # :this_might_be_the_way
...
IO.puts Numbers.classify_number(4)    # "Even integer"
IO.puts Numbers.classify_number(7)    # "Odd integer"
IO.puts Numbers.classify_number(3.14) # "Floating-point number"
